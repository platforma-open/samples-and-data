...
- Updated dependencies [9d96dff]
  - @platforma-open/milaboratories.samples-and-data.parse-seurat@1.1.4
  - @platforma-open/milaboratories.samples-and-data.parse-h5ad@1.1.5
...
- Updated dependencies [919bf93]
  - @platforma-open/milaboratories.samples-and-data.parse-h5ad@1.1.4
  - @platforma-open/milaboratories.samples-and-data.parse-seurat@1.1.3

## 2.7.1

### Patch Changes

- Updated dependencies [36f4458]
  - @platforma-open/milaboratories.samples-and-data.parse-seurat@1.1.2
...
- Updated dependencies [47cb5bb]
  - @platforma-open/milaboratories.samples-and-data.parse-h5ad@1.1.3
