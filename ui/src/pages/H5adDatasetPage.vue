...
import type { DSH5ad, PlId } from '@platforma-open/milaboratories.samples-and-data.model';
...
const columnDefs = computed(() => {
  const res: ColDef<H5adDatasetRow>[] = [
    makeRowNumberColDef(),
  ...
  } as ColDef<H5adDatasetRow, ImportFileHandle>);

  return res;
});

const gridOptions: GridOptions<H5adDatasetRow> = {
