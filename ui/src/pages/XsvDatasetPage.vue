...
const columnDefs = computed(() => {
  const res: ColDef<XsvDatasetRow>[] = [makeRowNumberColDef(), agSampleIdColumnDef(app)];
    ...
    cellRendererSelector: (params) =>
      params.data?.sample
        ? {
            ...
            params: {
              extensions: dataset.content.gzipped
                ? dataset.content.xsvType
                  ? [dataset.content.xsvType + ".gz"]
                  : ["csv.gz", "tsv.gz"]
                : dataset.content.xsvType
                  ? [dataset.content.xsvType]
                  : ["csv", "tsv"],
