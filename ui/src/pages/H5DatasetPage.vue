...
import type { DSH5, PlId } from '@platforma-open/milaboratories.samples-and-data.model';
...
const columnDefs = computed(() => {
  ...
  } as ColDef<H5DatasetRow, ImportFileHandle>);

  return res;
});

const gridOptions: GridOptions<H5DatasetRow> = {
