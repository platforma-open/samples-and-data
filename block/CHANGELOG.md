...
- Updated dependencies [6bf4907]
  - @platforma-open/milaboratories.samples-and-data.ui@2.10.0

## 1.17.4

### Patch Changes

- Updated dependencies [919bf93]
  - @platforma-open/milaboratories.samples-and-data.model@2.8.1
  - @platforma-open/milaboratories.samples-and-data.ui@2.9.3
  - @platforma-open/milaboratories.samples-and-data.workflow@2.7.2

## 1.17.3

### Patch Changes

- Updated dependencies [9fe1afb]
  - @platforma-open/milaboratories.samples-and-data.ui@2.9.2
...
- Updated dependencies [dbe82e5]
  - @platforma-open/milaboratories.samples-and-data.ui@2.9.1

## 1.17.0

### Minor Changes

- 72cbda6: Multiplexed FASTQ: fix sample-group labels and merge same-named samples across file groups.
...
- Updated dependencies [72cbda6]
- Updated dependencies [5ce12fc]
  - @platforma-open/milaboratories.samples-and-data.workflow@2.7.0
  - @platforma-open/milaboratories.samples-and-data.ui@2.9.0
  - @platforma-open/milaboratories.samples-and-data.model@2.8.0
...
- Updated dependencies [c8d92d5]
  - @platforma-open/milaboratories.samples-and-data.model@2.7.0
  - @platforma-open/milaboratories.samples-and-data.ui@2.8.0
